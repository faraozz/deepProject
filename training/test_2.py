...
MODEL_PATH="../models/regular_classification_batch_size128_epochs20_mom0.9_weightdec0.0005_lrt0.001_pretrainedFalse"
...
# Load test dataset
test_dataset_origin = ImageFolder(testpath)
